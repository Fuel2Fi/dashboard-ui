...
def main():
    assets = ["BTC", "ETH", "SOL"]  # Add or remove tickers as you wish
    trailing_stop_pct = 5
    results = []
    ...
    results_df.to_csv("multi_asset_results.csv", index=False)
    print("✅ Multi-asset backtest completed. Results saved to multi_asset_results.csv")
