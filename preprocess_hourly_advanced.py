...
"""
preprocess_hourly_advanced.py
Processes Binance hourly OHLC data with advanced features.
"""
...
print("\n✅ Advanced hourly preprocessing complete. Features saved to ./data/X_features.csv, targets saved to ./data/y_targets.csv.")
